    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 pt-6 border-t border-blue-400/30">
                <div>
                  ...
                  <div className="text-sm text-blue-200">Incluida</div>
                </div>
                <div>
                  <div className="text-3xl font-bold mb-1">Telemedicina</div>
                  <div className="text-sm text-blue-200">HD</div>
                </div>
                <div>
                  <div className="text-3xl font-bold mb-1">Seguro</div>
                  <div className="text-sm text-blue-200">Firewall</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl">
              ...
              <p className="text-blue-100 text-sm mb-6">Recibe asesoría especializada ETB Consultorios</p>
              <QuickCallForm buttonColor="#3b82f6" provider="ETB Consultorios" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <QuickCallForm provider="ETB Consultorios" buttonColor="#3b82f6" />
        </div>
      </section>
