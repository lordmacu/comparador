...
const offers: Offer[] = [
  {
    ...
    subtitle: 'Internet Fibra 900 Mbps',
    speed: 900,
    originalPrice: 95000,
    discountedPrice: 0,
    discount: 100,
    benefits: [
      ...
      'WiFi 6 mesh premium incluido',
      'Instalación sin costo',
      'Sin permanencia mínima',
      'Soporte técnico 24/7 VIP',
    ],
    savings: 285000,
    validUntil: '2026-01-31',
    terms: 'Aplica para nuevos clientes. Después del 3er mes pagas $95.000/mes. Instalación sujeta a cobertura.',
    featured: true,
    limited: true,
    color: 'blue',
  },
  ...
  },
  {
    id: 'etb-teletrabajo',
    provider: 'ETB',
    title: '2 Meses Gratis',
    subtitle: 'Plan Teletrabajo 300 Mbps',
    speed: 300,
    originalPrice: 65000,
    ...
    benefits: [
      ...
      'Precio especial $42.000/mes después',
      'WiFi 360 incluido',
      'IP estática opcional',
      'VPN optimizada para trabajo',
      'Backup de conectividad',
    ],
    savings: 130000,
    validUntil: '2026-01-31',
    terms: 'Exclusivo para trabajadores remotos. Verificación de actividad laboral requerida.',
    color: 'blue',
  },
  {
    id: 'movistar-gamer',
